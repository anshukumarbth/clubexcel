...
const domains = [
	{
		...
		description:
			"Master modern web technologies, frameworks, and best practices to build stunning web applications.",
	...
	},
	{
		...
		description:
			"Create powerful mobile applications for iOS and Android using cutting-edge frameworks.",
	...
	},
	{
		...
		description:
			"Dive into artificial intelligence, deep learning, and build intelligent systems.",
	...
	},
	{
		...
		title: "Cybersecurity",
		description:
			"Learn ethical hacking, penetration testing, and protect digital infrastructure.",
	...
	},
	{
		...
		description:
			"Sharpen your problem-solving skills and excel in coding competitions.",
	...
	},
	{
		...
		description:
			"Master cloud platforms, DevOps, and scalable infrastructure design.",
			...
			<div className="container mx-auto px-4 lg:px-8">
				...
				>
					...
					<p className="text-lg text-muted-foreground max-w-3xl mx-auto">
						Explore diverse technology domains and find your passion. Each domain
						offers comprehensive roadmaps and hands-on learning experiences.
					</p>
				</motion.div>
			</div>
