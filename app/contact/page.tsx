...
const contactInfo = [
  ...
  },
  {
    icon: Mail,
    title: "Email",
    content: "clubexcel@nist.edu",
    gradient: "from-purple-500 to-pink-500",
  },
  {
    icon: Phone,
    title: "Phone",
    content: "+91 7008680932",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="h-full p-6 rounded-2xl bg-card border border-border hover:border-blue-500/40 transition-all duration-300 text-center">
                  <motion.div
